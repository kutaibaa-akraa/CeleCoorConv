function cns_pick(al_1875,de_1875)
{
var cns_namemap=new Array(
"Андромеда (And: Andromeda) المسلسلة",
"Насос (Ant: Antlia) مفرغة الهواء",
"Райская птица (Aps: Apus) طائر الفردوس",
"Орел (Aql: Aquila) العقاب",
"Водолей (Aqr: Aquarius) الدلو",
"Жертвенник (Ara: Ara) المجمرة",
"Овен (Ari: Aries) الحمل",
"Возничий (Aur: Auriga) ممسك الأعنة",
"Волопас (Boo: Bootes) العوَّاء",
"Большой Пес (CMa: Canis Major) الكلب الأكبر",
"Малый Пес (CMi: Canis Minor) الكلب الأصغر",
"Гончие Псы (CVn: Canes Venatici) السلوقيان",
"Резец (Cae: Caelum) آلة النقاش",
"Жираф (Cam: Camelopardalis) الزرافة",
"Козерог (Cap: Capricornus) الجدي",
"Киль (Car: Carina) الشراع",
"Кассиопея (Cas: Cassiopeia) ذات الكرسي",
"Центавр (Cen: Centaurus) قنطورس",
"Цефей (Cep: Cepheus) قيقاوس",
"Кит (Cet: Cetus) قيطس",
"Хамелеон (Cha: Chamaeleon) الحرباء",
"Циркуль (Cir: Circinus) البيكار",
"Рак (Cnc: Cancer) السرطان",
"Голубь (Col: Columba) الحمامة",
"Волосы Вероники (Com: Coma Berenices) الهلبة",
"Южная Корона (CrA: Corona Australis) الإكليل الجنوبي",
"Северная Корона (CrB: Corona Borealis) الإكليل الشمالي",
"Чаша (Crt: Crater) الباطية",
"Южный Крест (Cru: Crux) الصليب",
"Ворон (Crv: Corvus) الغراب",
"Лебедь (Cyg: Cygnus) الدجاجة",
"Дельфин (Del: Delphinus) الدلفين",
"Золотая Рыба (Dor: Dorado) أبو سيف",
"Дракон (Dra: Draco) التنين",
"Малый Конь (Equ: Equuleus) قطعة الفرس",
"Эридан (Eri: Eridanus) النهر",
"Печь (For: Fornax) الكور",
"Близнецы (Gem: Gemini) التوأمين",
"Журавль (Gru: Grus) الكزكي",
"Геркулес (Her: Hercules) الجاثي",
"Часы (Hor: Horologium) الساعة",
"Гидра (Hya: Hydra) الشجاع",
"Южная Гидра (Hyi: Hydrus) حية الماء",
"Индеец (Ind: Indus) الهندي",
"Малый Лев (LMi: Leo Minor) الأسد الأصغر",
"Ящерица (Lac: Lacerta) العظاءة",
"Лев (Leo: Leo) الأسد",
"Заяц (Lep: Lepus) الأرنب",
"Весы (Lib: Libra) الميزان",
"Волк (Lup: Lupus) السبع",
"Рысь (Lyn: Lynx) الوشق",
"Лира (Lyr: Lyra) السلياق",
"Столовая Гора (Men: Mensa) الجبل",
"Микроскоп (Mic: Microscopium) المجهر",
"Единорог (Mon: Monoceros) وحيد القرن",
"Муха (Mus: Musca) البعوضة",
"Наугольник (Nor: Norma) مربع النجار",
"Октант (Oct: Octans) الثمن",
"Змееносец (Oph: Ophiuchus) الحوا",
"Орион (Ori: Orion) الجبَّار",
"Павлин (Pav: Pavo) الطاووس",
"Пегас (Peg: Pegasus) الفرس الأعظم",
"Персей (Per: Perseus) برشاوس",
"Феникс (Phe: Phoenix) العنقاء",
"Живописец (Pic: Pictor) آلة الرسام",
"Южная Рыба (PsA: Piscis Austrinus) الحوت الجنوبي",
"Рыбы (Psc: Pisces) الحوت",
"Корма (Pup: Puppis) الكوثل",
"Компас (Pyx: Pyxis) بيت الإبرة",
"Сетка (Ret: Reticulum) الشبكة",
"Скульптор (Scl: Sculptor) آلة النحات",
"Скорпион (Sco: Scorpius) العقرب",
"Щит (Sct: Scutum) الترس",
"Голова Змеи (Ser: Serpens Caput) الحيَّة",
"Секстант (Sex: Sextans) آلة السدس",
"Стрела (Sge: Sagitta) السهم",
"Стрелец (Sgr: Sagittarius) القوس ",
"Телец (Tau: Taurus) الثور",
"Телескоп (Tel: Telescopium) المرقب",
"Южный Треугольник (TrA: Triangulum Australe) المثلث الجنوبي",
"Треугольник (Tri: Triangulum) المثلث",
"Тукан (Tuc: Tucana) الطوقان",
"Большая Медведица (UMa: Ursa Major) الدب الأكبر",
"Малая Медведица (UMi: Ursa Minor) الدب الأصغر",
"Паруса (Vel: Vela) الشراع",
"Дева (Vir: Virgo) العذراء",
"Летучая Рыба (Vol: Volans) السمكة الطائرة",
"Лисичка (Vul: Vulpecula) الثعلب",
"Хвост Змеи (Ser: Serpens Cauda) الحية");

var cbound = new Array(
...
var ra = Math.floor( al_1875 * 180/Math.PI / 15 * 1800 );
var de = Math.floor( de_1875 * 180/Math.PI * 60 );
var i = Math.floor(( de + 5400 ) / 300);
if ( i < 0 || i > 36 ) return (-1);
i = start[i];
for (i=0 ; i < 357; i++ ){
	if ( cbound[i*4+2]<=de && cbound[i*4+1]>ra && cbound[i*4]<=ra) break;}
var icon = ( i == 357 ) ? -1 : Math.floor(cbound[i*4+3]);
